...
public class MessageFragment extends EaseConversationListFragment {
 ...
 /*       mRlBack = (RelativeLayout) errorView.findViewById(R.id.rl_back);
        mRlBack.setVisibility(View.GONE);
        mTvTitle = (TextView) errorView.findViewById(R.id.tv_title);
        mTvTitle.setText("消息");*/
    ...
    public void onResume() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
            ...
            window.setStatusBarColor(getResources().getColor(R.color.bc_title));
        }
    }
}
