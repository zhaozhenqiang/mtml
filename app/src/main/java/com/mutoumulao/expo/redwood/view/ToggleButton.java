...
public class ToggleButton extends View {
	...
	/** 开启颜色*/
	private int onColor = Color.parseColor("#3dc4f5");
	/** 关闭颜色*/
	...
	public void setup(AttributeSet attrs) {
		onColor=mContext.getResources().getColor(R.color.bc_blue);
		...
		offBorderColor = typedArray.getColor(R.styleable.ToggleButton_offBorderColorToggleButton, offBorderColor);
		onColor = typedArray.getColor(R.styleable.ToggleButton_onColorToggleButton, onColor);
		spotColor = typedArray.getColor(R.styleable.ToggleButton_spotColorToggleButton, spotColor);
		offColor = typedArray.getColor(R.styleable.ToggleButton_offColorToggleButton, offColor);
		borderWidth = typedArray.getDimensionPixelOffset(R.styleable.ToggleButton_borderWidthToggleButton, borderWidth);
		defaultAnimate = typedArray.getBoolean(R.styleable.ToggleButton_animateToggleButton, defaultAnimate);
		typedArray.recycle();
