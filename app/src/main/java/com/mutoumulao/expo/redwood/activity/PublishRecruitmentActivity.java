...
public class PublishRecruitmentActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        if ("0".equals(mType)) {
            ...
            mTvTitle.setText("发布招聘");

        }else if("2".equals(mType)){
            mTvTitle.setText("发布求职");
        }

        mBtnGo.setText("确认发布");
        mAdapter = new GridImageAdapter(this, onAddPicClickListener);
        FullyGridLayoutManager manager = new FullyGridLayoutManager(PublishRecruitmentActivity.this, 3, GridLayoutManager.VERTICAL, false);
        ...
        mAdapter.setOnItemClickListener(new GridImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                if (selectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            PictureSelector.create(PublishRecruitmentActivity.this).externalPicturePreview(position, selectList);
                            break;
                        default:
                            break;
                    }
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            PictureSelector.create(PublishRecruitmentActivity.this)
                    .openGallery(ofImage())
...
//                    .compressGrade(Luban.with(this))// luban压缩档次，默认3档 Luban.FIRST_GEAR、Luban.CUSTOM_GEAR
    ...
    private void publish() {
        ...
        if ("0".equals(mType)) {
            MineFuncManager.getInstance().publishService(title, remark, mCategory_id, images, new ResponseCallback() {
                @Override
                ...
                public void onStart() {
                    super.onStart();
                    UIUtil.showProgressBar(PublishRecruitmentActivity.this);
                }

                @Override
                public void onFinish() {
                    super.onFinish();
                    UIUtil.hideProgressBar(PublishRecruitmentActivity.this);
                }
            });

        } else if ("1".equals(mType)) {
            MineFuncManager.getInstance().publishRecruitment(title, remark, images, new ResponseCallback() {
                @Override
                public void onSuccess(Object o) {
                    super.onSuccess(o);
                    finish();
            ...
            MineFuncManager.getInstance().publishJob(title, remark, images, new ResponseCallback() {
                @Override
                public void onSuccess(Object o) {
                    super.onSuccess(o);
                    finish();
