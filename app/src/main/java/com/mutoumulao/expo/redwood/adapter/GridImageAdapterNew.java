 ...
 * data：16/7/27
 */
public class GridImageAdapterNew extends BaseAdapter<String, GridImageAdapterNew.ViewHolder> {
    ...
    public GridImageAdapterNew(Context context, onAddPicClickListener mOnAddPicClickListener) {
        super(context, null);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            mBitmapTools.display(viewHolder.mImg, UrlConst.IMAGE_URL + media);
