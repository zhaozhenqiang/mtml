...
public class BaseRecyclerView extends RecyclerView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mDividerHeight = a.getDimensionPixelOffset(R.styleable.BaseRecyclerView_android_dividerHeight, 1);
            ...
            mVerticalSpacing = a.getDimensionPixelOffset(R.styleable.BaseRecyclerView_android_verticalSpacing, 0);
            mHorizontalSpacing = a.getDimensionPixelOffset(R.styleable.BaseRecyclerView_android_horizontalSpacing, 0);
            mHeaderDividersEnabled = a.getBoolean(R.styleable.BaseRecyclerView_android_headerDividersEnabled, true);
            mFooterDividersEnabled = a.getBoolean(R.styleable.BaseRecyclerView_android_footerDividersEnabled, false);
            a.recycle();
...
//            LogUtils.d("bacy" + mOrientation);
        ...
        if (mOrientation == HORIZONTAL) {
            itemDecoration = new DividerItemDecoration(context, DividerItemDecoration.HORIZONTAL_LIST, mDividerId, mDividerHeight);
            itemDecoration.setFooterDividersEnabled(mFooterDividersEnabled);
            itemDecoration.setHeaderDividersEnabled(mHeaderDividersEnabled);
            addItemDecoration(itemDecoration);
        } else {
            itemDecoration = new DividerItemDecoration(context, DividerItemDecoration.VERTICAL_LIST, mDividerId, mDividerHeight);
            itemDecoration.setFooterDividersEnabled(mFooterDividersEnabled);
            itemDecoration.setHeaderDividersEnabled(mHeaderDividersEnabled);
            addItemDecoration(itemDecoration);
        }
