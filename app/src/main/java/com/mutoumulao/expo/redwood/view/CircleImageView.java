...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        float cornerRadiusOverride =
                a.getDimensionPixelOffset(R.styleable.CircleImageView_corner_radius, -1);

        mCornerRadii[Corner.TOP_LEFT] =
                a.getDimensionPixelOffset(R.styleable.CircleImageView_corner_radius_top_left, -1);
        mCornerRadii[Corner.TOP_RIGHT] =
                a.getDimensionPixelOffset(R.styleable.CircleImageView_corner_radius_top_right, -1);
        mCornerRadii[Corner.BOTTOM_RIGHT] =
                a.getDimensionPixelOffset(R.styleable.CircleImageView_corner_radius_bottom_right, -1);
        mCornerRadii[Corner.BOTTOM_LEFT] =
                a.getDimensionPixelOffset(R.styleable.CircleImageView_corner_radius_bottom_left, -1);
        ...
        mBorderWidth = a.getDimensionPixelOffset(R.styleable.CircleImageView_border_width, -1);
        if (mBorderWidth < 0) {
    ...
    public void setCornerRadiusDimen(@Corner int corner, @DimenRes int resId) {
        setCornerRadius(corner, getResources().getDimensionPixelOffset(resId));
    }
