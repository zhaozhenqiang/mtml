...
public class RequestParams {
    ...
    protected String method = com.mutoumulao.expo.redwood.util.http.HttpMethod.GET;    // 请求谓词
    ...
    public void addBodyParameter(String key, File file, String fileName, String mimeType) {
        if (fileParams == null) {
            fileParams = new ArrayList<>();
        }
        fileParams.add(new FileWrapper(key, file, fileName, mimeType));
    }
